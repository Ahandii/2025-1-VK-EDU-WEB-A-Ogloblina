...
from questions.views import index_view, DetailView, QuestionAskView, QuestionsTagView, QuestionsHotView

app_name = "questions"
urlpatterns = [
    re_path(r'^(?P<pk>\d+)/detail/', DetailView.as_view(), name="question_detail"),
    re_path(r'^tag/(?P<pk>)', QuestionsTagView.as_view(), name="questions_tag"),
